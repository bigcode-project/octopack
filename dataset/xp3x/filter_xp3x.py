...
cd xP3x
git lfs pull --include="data/python/*.jsonl"
git lfs pull --include="data/jupyter*/*.jsonl"
git lfs pull --include="data/java/*.jsonl"
mv data/jupyter*/* data/python/
mv data/java/* data/python/
cd data/python/
python filter_xp3x.py
"""
