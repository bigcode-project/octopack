...
--save_generations_path generations_humanevalxexplaindesc_instructcodet5p_temp02.json \
--modeltype seq2seq \
...
--trust_remote_code \
--mutate_method instruct \
--load_data_path generations_humanevalxexplaindesc_instructcodet5p_temp02.json \
--save_generations_path generations_humanevalxexplaingen_instructcodet5p_temp02.json \
--metric_output_path evaluation_humanevalxexplain_instructcodet5p_temp02.json \
--modeltype seq2seq \
--max_length_generation 2048 \
--precision fp16
