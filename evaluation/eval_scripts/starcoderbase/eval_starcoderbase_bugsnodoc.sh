...
--save_generations \
--trust_remote_code \
--mutate_method editnodoc \
--save_generations_path generations_humanevalxbugspyeditnodoc_starcoderbase_temp02.json \
--metric_output_path evaluation_humanevalxbugspyeditnodoc_starcoderbase_temp02.json \
