...
--save_generations_path generations_humanevalxexplaindesc_starchatbeta_temp02.json \
...
--trust_remote_code \
--mutate_method instruct \
--load_data_path generations_humanevalxexplaindesc_starchatbeta_temp02.json \
--save_generations_path generations_humanevalxexplaingen_starchatbeta_temp02.json \
--metric_output_path evaluation_humanevalxexplain_starchatbeta_temp02.json \
--max_length_generation 2048 \
--precision bf16
