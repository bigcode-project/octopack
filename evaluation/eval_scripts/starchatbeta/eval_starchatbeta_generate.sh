...
--save_generations_path generations_humanevalxgeneratecpp_starchatbeta_temp02.json \
--metric_output_path evaluation_humanevalxgeneratecpp_starchatbeta_temp02.json \
