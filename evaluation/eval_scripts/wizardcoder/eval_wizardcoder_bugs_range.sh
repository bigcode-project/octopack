...
for ((i=0; i<164; i++)); do
    eval_script="./eval_wizard_$i.slurm"
    SAVE_GEN_PATH=generations_hexbugs$LANG\_wizardcoder_$i.json
    METRIC_OUTPUT_PATH=evaluation_hexbux$LANG\_wizardcoder_$i.json
    # Skip if exists
