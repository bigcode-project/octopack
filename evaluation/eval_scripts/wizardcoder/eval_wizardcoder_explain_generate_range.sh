...
for ((i=0; i<164; i++)); do
    ...
    SAVE_GEN_PATH_GEN=generations_hexexplaingen$LANG\_wizardcoder_$i.json
    METRIC_OUTPUT_PATH_GEN=evaluation_hexexplaingen$LANG\_wizardcoder_$i.json
    # Skip if exists
...
--load_data_path generations_hexexplaindesc$LANG\_wizardcoder.json \
