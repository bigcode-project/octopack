        ...
        **model_kwargs,
        ...
        while True:
            ...
            if eos_token_id_tensor is not None:
                #print("TENSOR")
                #print(eos_token_id_tensor)
                #print("NEXT TOKENS")
                #print(next_tokens)
                #print("UNSQUEEZED")
                #print(eos_token_id_tensor.unsqueeze(1))
                #print("TILED")
                #print(next_tokens.tile(eos_token_id_tensor.shape[0], 1))
                #print("NE")
                #print(next_tokens.tile(eos_token_id_tensor.shape[0], 1).ne(eos_token_id_tensor.unsqueeze(1)))
                unfinished_sequences = unfinished_sequences.mul(
                    next_tokens.tile(eos_token_id_tensor.shape[0], 1).ne(eos_token_id_tensor.unsqueeze(1)).cpu().prod(dim=0).cuda()
                )
