...
def human_eval_docstrings():
    docstrings = []
    # TODO: Rust
    for lang in ["python", "java", "js", "go", "cpp"]:
...
cols_to_select = ["commit", "content", "subject", "lang", "size"] + ["proba"] if "proba" in ds.column_names else []
