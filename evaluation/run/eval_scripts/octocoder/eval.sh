...
--save_generations_path generations_humanevalsynthesizepy_starcodergc250_temp02.json \
--metric_output_path evaluation_humanevalsynthesizepy_starcodergc250_temp02.json \
