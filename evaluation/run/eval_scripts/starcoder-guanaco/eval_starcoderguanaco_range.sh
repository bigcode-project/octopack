...
for ((i=0; i<1; i++)); do
    ...
    SAVE_GEN_PATH=generations_hexexplaindescpy_starcoderguanaco_$i.json
    METRIC_OUTPUT_PATH=evaluation_hexexplaindescpy_starcoderguanaco_$i.json
    SAVE_GEN_PATH_GEN=generations_hexexplaingenpy_starcoderguanaco_$i.json
    METRIC_OUTPUT_PATH_GEN=evaluation_hexexplaingenpy_starcoderguanaco_$i.json    
    # Skip if exists
