...
--save_generations \
--trust_remote_code \
--mutate_method edit-complete \
--save_generations_path generations_humanevalxgeneratepyeditcomplete_starcoderbase_temp02.json \
--metric_output_path evaluation_humanevalxgeneratepyeditcomplete_starcoderbase_temp02.json \
