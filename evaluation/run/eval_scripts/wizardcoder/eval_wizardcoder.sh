...
accelerate launch --config_file config_1gpus_bf16.yaml --main_process_port 20788 main.py \
...
--save_generations_path generations_humanevalxbugspy_wizardcoder_temp02.json \
--metric_output_path evaluation_humanevalxbugspy_wizardcoder_temp02.json \
