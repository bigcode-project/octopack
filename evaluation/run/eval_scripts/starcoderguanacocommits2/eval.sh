...
--save_generations \
--trust_remote_code \
--mutate_method starcodercommit2 \
...
--trust_remote_code \
--mutate_method starcodercommit2 \
--load_generations_path generations_humanevalxexplaingeneratepy_starcoderguanacocommits2_temp02_v2.json \
--metric_output_path evaluation_humanevalxexplainpy_starcoderguanacocommits2_temp02.json \
--max_length_generation 2048 \
--precision bf16